 ...
 *
 * Loads release notes from bundled assets and syncs them to ~/.grose-agent/release-notes/.
...
function loadBundledReleaseNotes(): Record<string, string> {
  ...
  // Try bundled assets first, fall back to ~/.grose-agent/release-notes/
  // (Docker/remote server may not have GROSE_BUNDLED_ASSETS_ROOT set,

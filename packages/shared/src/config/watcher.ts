 ...
 *
 * Watched paths:
 * - ~/.grose-agent/config.json - Main app configuration
 * - ~/.grose-agent/preferences.json - User preferences
 * - ~/.grose-agent/theme.json - App-level theme overrides
 * - ~/.grose-agent/themes/*.json - Preset theme files (app-level)
 * - ~/.grose-agent/workspaces/{slug}/ - Workspace directory (recursive)
...
export interface ConfigWatcherCallbacks {
  ...
  /** Called when app-level default permissions change (~/.grose-agent/permissions/default.json) */
...
export class ConfigWatcher {
  ...
  /**
   * Watch app-level themes directory (~/.grose-agent/themes/)
   */
  ...
  /**
   * Watch app-level permissions directory (~/.grose-agent/permissions/)

 ...
 *
 * The mapping lives in ~/.grose-agent/tool-icons/tool-icons.json alongside the
 ...
 *
 * @param toolIconsDir - Path to the tool-icons directory (e.g. ~/.grose-agent/tool-icons/)
 ...
 *
 * @param commandStr - Full bash command string, e.g. "git add . && npm publish"
 * @param toolIconsDir - Path to ~/.grose-agent/tool-icons/ containing tool-icons.json and icon files

...
export abstract class BaseEventAdapter {
   ...
   * (e.g., "grose__search_spaces") because the pool strips the `mcp__` prefix.
   * We just need to re-add `mcp__` to produce "mcp__grose__search_spaces".
   * Without this, we'd get "mcp__sources__grose__search_spaces" which breaks

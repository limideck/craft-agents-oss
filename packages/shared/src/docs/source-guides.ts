 ...
 * Guides are now served exclusively via the grose-agents-docs MCP server.
 *
 ...
 * Use the grose-agents-docs MCP server to search for setup guides.
 *
 * Example: mcp__grose-agents-docs__SearchGroseAgents({ query: "github source setup guide" })
 */

 ...
 * `@grose-agent/messaging-whatsapp-worker` subprocess.
 *
 ...
 *
 * The worker contract is defined in @grose-agent/messaging-whatsapp-worker.
...
import {
  ...
  type WorkerCommand,
  type WorkerEvent,
} from '@grose-agent/messaging-whatsapp-worker'
import type {
  PlatformAdapter,
  PlatformConfig,
  AdapterCapabilities,

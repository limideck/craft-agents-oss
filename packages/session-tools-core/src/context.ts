...
export interface SessionToolContext {
  ...
  /** Absolute path to workspace folder (~/.grose-agent/workspaces/{id}) */
   ...
   * - Claude: writes JSON files to ~/.grose-agent/feedback/
...
export interface ResolvedLabelsResult {
   ...
   * Populated by `resolveSessionLabels()` from `@grose-agent/shared/labels`.

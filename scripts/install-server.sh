#!/usr/bin/env bash
# install-server.sh — Set up the Grose Agent standalone server.
#
# Usage:
...
echo ""
echo "===================================="
echo "  Grose Agent Server Ready"
echo "===================================="
echo ""
echo "Start the server (with Web UI):"
echo ""
echo "  GROSE_SERVER_TOKEN=$TOKEN \\"
echo "  GROSE_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  GROSE_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
...
echo "  GROSE_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  GROSE_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  GROSE_RPC_HOST=0.0.0.0 \\"
echo "  GROSE_RPC_PORT=9100 \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""
...
echo "  GROSE_WEBUI_DIR=$REPO_ROOT/apps/webui/dist \\"
echo "  GROSE_BUNDLED_ASSETS_ROOT=$REPO_ROOT/apps/electron \\"
echo "  GROSE_RPC_TLS_CERT=/path/to/cert.pem \\"
echo "  GROSE_RPC_TLS_KEY=/path/to/key.pem \\"
echo "  bun run $REPO_ROOT/packages/server/src/index.ts"
echo ""

...
func registerSitesTools(server *sdkmcp.Server, c *client) {
	sdkmcp.AddTool(server, &sdkmcp.Tool{
		Name:        "sites_list",
		Description: "List all sites in the workspace (id, name, slug, template, path, status, preview). Call before claiming a site already exists. Pass workspace_id from <craft_modules>.",

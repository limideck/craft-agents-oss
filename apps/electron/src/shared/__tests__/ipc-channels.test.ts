...
const EXPECTED_CHANNELS: string[] = [
  ...
  'copilot:logout',
  'copilot:startOAuth',
  'craftModules:getConfig',
  'craftModules:getStatus',
  'craftModules:restart',
  ...
  'openConnector:fetch',
  'openConnector:getConfig',
  'openConnector:getStatus',
  'openConnector:restart',

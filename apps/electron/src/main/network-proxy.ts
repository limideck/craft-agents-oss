...
import { getNetworkProxySettings, setNetworkProxySettings } from '@grose-agent/shared/config/storage';
import type { NetworkProxySettings } from '@grose-agent/shared/config/types';

 ...
 * electron-updater library. Updates are served from https://agents.grose.do/electron/latest
...
import { getAppVersion } from '@grose-agent/shared/version'
import {
  getDismissedUpdateVersion,
  clearDismissedUpdateVersion,
} from '@grose-agent/shared/config'
import { readJsonFileSync } from '@grose-agent/shared/utils/files'

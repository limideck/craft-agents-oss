...
import type { ChatDisplayHandle } from '@/components/sessions/ChatDisplay'
import type {
  Session,
  Workspace,
  FileAttachment,
...
export interface AppShellContextType {
  ...
  getDraftAttachmentRefs: (sessionId: string) => import('@grose-agent/shared/config').DraftAttachmentRef[]
  ...
  onSendMessage: (sessionId: string, message: string, attachments?: FileAttachment[], skillSlugs?: string[], badges?: import('@grose-agent/core').ContentBadge[]) => void

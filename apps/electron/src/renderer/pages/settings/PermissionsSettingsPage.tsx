 ...
 * Shows both default patterns (from ~/.grose-agent/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.grose-agent/permissions/default.json.
...
/**
 * Build default permissions data from ~/.grose-agent/permissions/default.json.

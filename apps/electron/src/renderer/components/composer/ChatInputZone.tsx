...
import { flattenLabels, type LabelConfig } from '@grose-agent/shared/labels'
import type { PermissionMode } from '@grose-agent/shared/agent/modes'
import type { SessionStatus } from '@/config/session-status-config'
import type { BackgroundTask } from '../sessions/ActiveTasksBar'
import { ActiveOptionBadges } from '../sessions/ActiveOptionBadges'

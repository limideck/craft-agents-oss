...
import { PERMISSION_MODE_CONFIG, type PermissionMode } from '@grose-agent/shared/agent/modes'
...
import { flattenLabels, parseLabelEntry, formatLabelEntry, formatDisplayValue } from '@grose-agent/shared/labels'
import { resolveEntityColor } from '@grose-agent/shared/colors'

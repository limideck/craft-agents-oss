...
import { ChatInputZone, type StructuredInputState, type StructuredResponse, type PermissionResponse, type AdminApprovalResponse } from "../composer"
...
interface ChatDisplayProps {
  ...
  labels?: import('@grose-agent/shared/labels').LabelConfig[]
...
export const ChatDisplay = React.forwardRef<ChatDisplayHandle, ChatDisplayProps>(function ChatDisplay({
  ...
  // These settings are stored in ~/.grose-agent/preferences.json (not localStorage)
  ...
  const handleSaveAndSendFollowUp = useCallback((_target: {
    ...
    window.setTimeout(() => {
      window.dispatchEvent(new CustomEvent('grose:submit-input', {
                    ...
                    return (
                      ...
                      <TurnCard
                        ...
                        onAcceptPlan={() => {
                          ...
                          window.dispatchEvent(new CustomEvent('grose:approve-plan', {
                            detail: {
                              sessionId: session?.id,
                              planPath,
                        ...
                        onAcceptPlanWithCompact={() => {
                          ...
                          window.dispatchEvent(new CustomEvent('grose:approve-plan-with-compact', {
                            detail: {
                              sessionId: session?.id,
                              planPath,
                              includeDraftInput: true,

...
import { SourceMenu } from '../info/SourceMenu'
import { SendResourceToWorkspaceDialog } from '../automations/SendResourceToWorkspaceDialog'
        ...
        return {
          ...
          menu: (
            <SourceMenu
              ...
              onOpenInNewWindow={() => window.electronAPI.openUrl(`groseagents://sources/source/${source.config.slug}?window=focused`)}

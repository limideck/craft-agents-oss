...
import { SessionSearchHeader } from '@/components/sessions/SessionSearchHeader'
...
import { SendResourceToWorkspaceDialog } from '@/components/automations/SendResourceToWorkspaceDialog'

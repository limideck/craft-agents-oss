...
echo "=== Building Grose Agents AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Grose-Agents-x86_64.AppImage or Grose-Agents-aarch64.AppImage
BUILT_APPIMAGE_NAME="Grose-Agents-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Grose-Agents-x64.AppImage, Grose-Agents-arm64.AppImage
APPIMAGE_NAME="Grose-Agents-${ARCH}.AppImage"

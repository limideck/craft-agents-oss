...
Use `browser_tool` to control built-in browser windows (Chromium) inside Grose Agents.
...
- Before first browser tool usage, the agent must read this guide (`~/.grose-agent/docs/browser-tools.md`).

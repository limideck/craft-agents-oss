...
> **CLI-first workflow (recommended):** Use `grose-agent permission ...` commands instead of editing JSON directly.
> - `grose-agent permission --help`
...
- Source: `~/.grose-agent/workspaces/{slug}/sources/{source}/permissions.json`

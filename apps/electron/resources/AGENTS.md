...
This folder contains assets that are bundled with the Electron app and synced to the user's `~/.grose-agent/` directory on every launch.
...
|-------------|-----------|---------------|
| `docs/` | `~/.grose-agent/docs/` | Always overwrite on launch |
| `themes/` | `~/.grose-agent/themes/` | Always overwrite on launch |
| `permissions/` | `~/.grose-agent/permissions/` | Always overwrite on launch |
| `tool-icons/` | `~/.grose-agent/tool-icons/` | Always overwrite on launch |
| `release-notes/` | `~/.grose-agent/release-notes/` | Always overwrite on launch |
| `config-defaults.json` | `~/.grose-agent/config-defaults.json` | Always overwrite on launch |

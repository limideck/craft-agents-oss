...
We take security seriously. If you discover a security vulnerability in Grose Agents, please report it responsibly.

### How to Report

**Please do NOT report security vulnerabilities through public GitHub issues.**

Instead, please send an email to: **security@grose.do**
...
- The Grose Agents desktop application
- The `@grose-agent/*` npm packages
- Official Grose Agents repositories
